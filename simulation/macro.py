...
jsubf.write(args.src+"/"+args.version+"/bin/remoll "+macro+"\n")
jsubf.write("echo \"Program remoll finished with exit code $? at: `date`\"\n")
jsubf.write("mv "+args.work_dir+"/${SLURM_ARRAY_JOB_ID}/"+args.gen+"_${SLURM_ARRAY_JOB_ID}_${SLURM_ARRAY_TASK_ID}_incomplete.root "+out+"/"+args.gen+"_${SLURM_ARRAY_JOB_ID}_${SLURM_ARRAY_TASK_ID}_complete.root ""\n")
