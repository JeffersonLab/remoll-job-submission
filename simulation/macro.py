...
parser.add_argument("-a", dest="account", action="store", required=False, default="halla", help="Enter the Jefferson Lab account. Example: halla")  
...
jsubf.write("#SBATCH --chdir="+args.src+"/"+args.version+"\n")
jsubf.write("mkdir -p macros/${SLURM_ARRAY_JOB_ID}\n")
jsubf.write("mkdir -p "+args.out_dir+"/${SLURM_ARRAY_JOB_ID}\n")
jsubf.write("mkdir -p "+args.work_dir+"/${SLURM_ARRAY_JOB_ID}\n")
# jsubf.write("cd ${SLURM_ARRAY_JOB_ID}\n")
# macro=args.work_dir+"/${SLURM_ARRAY_JOB_ID}/"+args.gen+"_${SLURM_ARRAY_JOB_ID}_${SLURM_ARRAY_TASK_ID}.mac"
macro="macros/${SLURM_ARRAY_JOB_ID}/"+args.gen+"_${SLURM_ARRAY_JOB_ID}_${SLURM_ARRAY_TASK_ID}.mac"
...
jsubf.write("echo /remoll/filename "+args.work_dir+"/${SLURM_ARRAY_JOB_ID}/"+args.gen+"_${SLURM_ARRAY_JOB_ID}_${SLURM_ARRAY_TASK_ID}_incomplete.root >>"+macro+"\n")
...
# jsubf.write("which remoll \n")
# jsubf.write("echo ${HOSTNAME}; date \n")
# jsubf.write("printenv \n")
# jsubf.write("touch "+args.work_dir+"/${SLURM_ARRAY_JOB_ID}/"+args.gen+"_${SLURM_ARRAY_JOB_ID}_${SLURM_ARRAY_TASK_ID}_incomplete.root \n")
